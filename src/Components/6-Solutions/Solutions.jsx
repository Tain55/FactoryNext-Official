    ...
    <div className="solution-1">
      <div className="solution-2">
        ...
        <div className="solutionLines">
          <div className="SLine line1">
            <img src={line3} alt="" />
          </div>
          <div className="SLine line2">
            <img src={line1} alt="" />
          </div>
          <div className="SLine line3">
            <img src={line5} alt="" />
          </div>
          <div className="SLine line4">
            <img src={line2} alt="" />
          </div>
          <div className="SLine line5">
            <img src={line4} alt="" />
          </div>
        </div>
        ...
        <div className="Solution-Design-Image">
          ...
          <div className="Solution-Details-1">
            ...
            <div className="Solution-text2">
              ...
              <p className="Solution-details">
                Strategic consultancy for integrating Industry 4.0 technologies
            ...
            <div className="solution-mobile-row">
              <Link to='/solutions' style={{ textDecoration: "none" }}>
                <div className="solution-mobile">
                  <div className="headingAndIcon">
                    ...
                    <p className="solution-mobile-heading">
                      Machine and Process Monitoring
                    </p>
                  </div>
                  <p className="solution-mobile-text">
                    Real-time tracking and analytics for equipment and processes
              ...
              <Link  to='/solutions'  style={{ textDecoration: "none" }}>
                <div className="solution-mobile ">
                  ...
                  <p className="solution-mobile-text">
                    Optimization of energy use and utility management for cost
              ...
              <Link  to='/solutions'  style={{ textDecoration: "none" }}>
                <div className="solution-mobile ">
                  ...
                  <p className="solution-mobile-text">
                    Strategic consultancy for integrating Industry 4.0
                    technologies into business operations.
                  </p>
                </div>
              </Link>
            </div>
            <div className="solution-mobile-row"></div>
